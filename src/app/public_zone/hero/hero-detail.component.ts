...
export class HeroDetailComponent {
    ...
    removeHero(): void {
	   ...
	   this.showModular('Removed', 'success', ()=> { });
       this.openPopup('small', 'Success remove', ()=> { this.goBack(); });
    }
    ...
    showModular(text: string, type: string, callbackOnClose: any): void {
        this.notify.show(text, { position:'top', duration:'2000', type: type, location: 'hero-detail' });
        setTimeout(()=> { callbackOnClose(); } , 1000);
	}
