...
//since it uses systemjs (jit) will cause issue (incompatible module)
//direct to node_modules solves issue
//strange behaviur, if update file and restart npm run start it will work
//import { Ng2PopupModule } from '../../../node_modules/ng2-popup'; 

/* Solution (bad, since we change manually node_modules)
Update module declaration file ng2-dropdown.module.d.ts as below
import { NgModule } from '@angular/core';
@NgModule() export declare class Ng2DropdownModule{*/
